...
import { HttpResponseDefault, HttpResponseList } from '../https/http-response.interface';
import { PageableUser, SingletonOrPageable } from '../pageables/pageable.interface';
